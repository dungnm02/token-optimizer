# Chỉnh sửa Ngữ cảnh (Cắt tỉa các lượt cũ) (Tiếng Việt)
...
## Nén (compaction) so với chỉnh sửa ngữ cảnh (context editing)

| | Chỉnh sửa ngữ cảnh (cắt tỉa) | Nén (tóm tắt) |
| --- | --- | --- |
...
| Thứ tự điển hình | Liên tục, suốt cả phiên | Khi tiệm cận ngân sách ngữ cảnh |
...
- Trong các transcript agent nặng về tool, kết quả tool thường chiếm
  **70–90% token lịch sử**; cắt tỉa những cái đã bị thay thế thường thu
  nhỏ ngữ cảnh ổn định **2–5×** mà không mất mát do tóm tắt.
- Anthropic báo cáo rằng chỉnh sửa ngữ cảnh kéo dài đáng kể độ dài tác vụ
  hiệu dụng trong khi *cải thiện* chất lượng trên các tác vụ dài (ngữ cảnh
  cũ là sự phân tâm, không chỉ là chi phí).
- **Đây là một đòn bẩy chất lượng, không chỉ là chi phí — "context rot"
  (sự suy thoái ngữ cảnh)**. Các nghiên cứu có kiểm soát trên 18 model
  hàng đầu cho thấy mỗi model đều suy giảm khi input tăng lên, và điều này
